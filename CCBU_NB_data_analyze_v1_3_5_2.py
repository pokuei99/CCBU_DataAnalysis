...
dir=""
window = tk.Tk()
window.title("CCBU_THMNB_Analyzer_v1.3.5.2")
...
def run_all():     
    ...
    if CheckVar1.get() == 1: #TAT
        if any(File.startswith('PTAT') or File.startswith('TAT') for File in os.listdir(dir)):#可以補上startswith('TAT') 2022/07/15
            ...
            #print(tatresult_allpower)
            tatresult_allpower_avg = (tatresult_allpower.tail(data_length_1)).mean().round(4)
            #print(tatresult_allpower.tail(data_length_1))
            #print(tatresult_allpower_avg)
            ...
            with pd.ExcelWriter(resultbook, mode="a", engine='openpyxl',if_sheet_exists="overlay") as writer:
                ...
                #tat_last_avg.set_column_width(columns=['A'],width=100)
    ...
    if CheckVar2.get() == 1: #YOKOGAWA
        if any(File.endswith(filetype_yoko) for File in os.listdir(dir)):
            ...
            if str(dropdown1.get()) == "None" or str(dropdown2.get()) == "None":
                pass
            else:
                #yokolog_I_V = yokolog_path3.iloc[:, -2:]
                yokolog_path3['System_Power'] = yokolog_path3[str(dropdown1.get())]*yokolog_path3[str(dropdown2.get())]
...
current1 = tk.Label(canvas, text='Current', font=('Microsoft New Tai Lue', 10))
current1_window = canvas.create_window(40, 270, anchor=NW, window=current1)
options1 = ["None", 
            "CH0001", "CH0002", "CH0003", "CH0004", "CH0005", "CH0006", "CH0007", "CH0008", "CH0009", "CH0010"
            , "CH0101", "CH0102", "CH0103", "CH0104", "CH0105", "CH0106", "CH0107", "CH0108", "CH0109", "CH0110"
            , "CH0201", "CH0202", "CH0203", "CH0204", "CH0205", "CH0206", "CH0207", "CH0208", "CH0209", "CH0210"
            , "CH0301", "CH0302", "CH0303", "CH0304", "CH0305", "CH0306", "CH0307", "CH0308", "CH0309", "CH0310"
            , "CH0401", "CH0402", "CH0403", "CH0404", "CH0405", "CH0406", "CH0407", "CH0408", "CH0409", "CH0410"
            , "CH0501", "CH0502", "CH0503", "CH0504", "CH0505", "CH0506", "CH0507", "CH0508", "CH0509", "CH0510"]
dropdown1 = ttk.Combobox(window, values=options1 , state="readonly")
dropdown1.current(0)
dropdwon1 = canvas.create_window(100, 270, anchor=NW, window=dropdown1)

voltage1 = tk.Label(canvas, text='Voltage', font=('Microsoft New Tai Lue', 10))
voltage1_window = canvas.create_window(250, 270, anchor=NW, window=voltage1)
options2 = ["None", 
            "CH0001", "CH0002", "CH0003", "CH0004", "CH0005", "CH0006", "CH0007", "CH0008", "CH0009", "CH0010"
            , "CH0101", "CH0102", "CH0103", "CH0104", "CH0105", "CH0106", "CH0107", "CH0108", "CH0109", "CH0110"
            , "CH0201", "CH0202", "CH0203", "CH0204", "CH0205", "CH0206", "CH0207", "CH0208", "CH0209", "CH0210"
            ...
            , "CH0401", "CH0402", "CH0403", "CH0404", "CH0405", "CH0406", "CH0407", "CH0408", "CH0409", "CH0410"
            , "CH0501", "CH0502", "CH0503", "CH0504", "CH0505", "CH0506", "CH0507", "CH0508", "CH0509", "CH0510"]
dropdown2 = ttk.Combobox(window, values=options2, state="readonly")
dropdown2.current(0)
dropdwon2 = canvas.create_window(310, 270, anchor=NW, window=dropdown2)


#dropdown= canvas.create_window(70, 245, anchor=NW)

# set the default value to the first option
#dropdown.current("Option 1")

# pack the widget into the window

#label2 = tk.Label(canvas, text='Voltage ', font=('Microsoft New Tai Lue', 10))
#label2_window = canvas.create_window(40, 245, anchor=NW, window=label1)
